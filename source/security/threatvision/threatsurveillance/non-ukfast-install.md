...
```eval_rst
.. note::
   This documentation is for setting on a non-UKFast hosted server with Threat Surveillance. Instructions on how to install Threat Surveillance and Response on a UKFast hosted server can be found in our :doc:`ukfast-hosted-install` documentation.
```
...
To begin, log into MyUKFast and visit the [Threat Surveillance new agent configuration page](https://my.ukfast.co.uk/threat-vision/configuration) then select `Non UKFast` from the `Hosting Type` drop-down option.
